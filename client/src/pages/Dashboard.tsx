        ...
        <div className="grid grid-cols-12 gap-6 mb-8">
          ...
          <div className="col-span-12 lg:col-span-8 h-[500px] bg-card rounded-2xl border border-border overflow-hidden relative shadow-xl">
            ...
            <div className="absolute inset-0">
               <iframe
                 src={`https://s.tradingview.com/widgetembed/?frameElementId=tradingview_76d87&symbol=${selectedPair.replace("/", "")}&interval=5&hidesidetoolbar=0&symboledit=1&saveimage=1&toolbarbg=f1f3f6&studies=["RSI@tv-basicstudies","MASimple@tv-basicstudies","MACD@tv-basicstudies"]&theme=dark&style=1&timezone=Etc%2FUTC`}
